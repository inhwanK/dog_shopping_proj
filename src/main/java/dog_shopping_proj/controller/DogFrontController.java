...
@WebServlet(urlPatterns = { "*.do" }, loadOnStartup = 1, // 1로 설정되어있기때문에 젤먼저 수행해라
		initParams = { @WebInitParam( // init(ServletConfig config) 에서 사용
				name = "configFile", value = "/WEB-INF/commandAction.properties") })
